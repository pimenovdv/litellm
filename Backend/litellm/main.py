...
def _complete_vertex_ai(ctx: _CompletionDispatchContext) -> _CompletionDispatchResult:
    ...
    if model_route == VertexAIModelRoute.PARTNER_MODELS:
        ...
        from litellm.llms.vertex_ai_and_google_aistudio.agent_engine.transformation import (
...
def speech(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai" or custom_llm_provider in litellm.openai_compatible_providers:
        ...
        from litellm.llms.elevenlabs.speech.transformation import (
        ...
        from litellm.llms.vertex_ai_and_google_aistudio.speech.transformation import (
        ...
        from litellm.llms.minimax.speech.transformation import (
        ...
        from litellm.llms.bedrock.speech.transformation import (
