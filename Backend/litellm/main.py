...
def _complete_vertex_ai(ctx: _CompletionDispatchContext) -> _CompletionDispatchResult:
    ...
    if model_route == VertexAIModelRoute.PARTNER_MODELS:
        ...
        from litellm.llms.vertex_ai.vertex_ai_agent_engine import (
...
def transcription(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "azure" and provider_config is None:
        ...
        from litellm.llms.soniox.audio_transcription import (
...
def speech(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai" or custom_llm_provider in litellm.openai_compatible_providers:
        ...
        from litellm.llms.elevenlabs.chat.text_to_speech import (
        ...
        from litellm.llms.vertex_ai.vertex_ai_text_to_speech import (
        ...
        from litellm.llms.minimax.text_to_speech import (
        ...
        from litellm.llms.aws_polly.text_to_speech import (
