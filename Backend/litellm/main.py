...
from litellm.llms.vertex_ai.vertex_llm_base import VertexAIModelRoute, get_vertex_ai_model_route
...
def _complete_vertex_ai(ctx: _CompletionDispatchContext) -> _CompletionDispatchResult:
    ...
    if model_route == VertexAIModelRoute.PARTNER_MODELS:
        ...
        from litellm.llms.vertex_ai.vertex_agent_engine.transformation import VertexAgentEngineConfig
