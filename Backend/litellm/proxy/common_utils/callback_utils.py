    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm.proxy.guardrails.init_guardrails import _OPTIONAL_PresidioPIIMasking
                ...
                from litellm.proxy.guardrails.init_guardrails import lakeraAI_Moderation
                ...
                from litellm.proxy.guardrails.init_guardrails import AporiaGuardrail
