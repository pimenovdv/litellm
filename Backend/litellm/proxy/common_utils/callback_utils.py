    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm_enterprise.enterprise_callbacks.presidio import (
                ...
                from litellm_enterprise.enterprise_callbacks.lakera_ai import (
                    lakeraAI_Moderation,
                )
                ...
                from litellm_enterprise.enterprise_callbacks.aporia import (
                    AporiaGuardrail,
                )
