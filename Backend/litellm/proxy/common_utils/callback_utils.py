    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm.integrations.presidio import _OPTIONAL_PresidioPIIMasking
                ...
                from litellm.integrations.lakeraAI import lakeraAI_Moderation
                ...
                from litellm.integrations.aporia import AporiaGuardrail
