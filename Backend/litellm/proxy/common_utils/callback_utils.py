    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm.proxy._lazy_features import _OPTIONAL_PresidioPIIMasking
                ...
                from litellm.proxy._lazy_features import lakeraAI_Moderation
                ...
                from litellm.proxy._lazy_features import AporiaGuardrail
