    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm.types.proxy.guardrails.guardrail_hooks.presidio import _OPTIONAL_PresidioPIIMasking
                ...
                from litellm.types.proxy.guardrails.guardrail_hooks.lakera_prompt_injection import lakeraAI_Moderation
