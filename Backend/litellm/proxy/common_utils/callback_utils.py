    ...
    if isinstance(value, list):
        ...
        for callback in value:  # ["presidio", <my-custom-callback>]
            ...
            if isinstance(callback, str) and callback in litellm._known_custom_logger_compatible_callbacks:
                ...
                from litellm.litellm_core_utils.pii_masking import (
                ...
                from litellm.litellm_core_utils.prompt_injection_detection.lakera_ai import (
                    lakeraAI_Moderation,
                )
                ...
                from litellm.litellm_core_utils.prompt_injection_detection.aporia_ai import (
                    AporiaGuardrail,
                )
