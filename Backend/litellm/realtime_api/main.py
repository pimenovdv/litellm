...
azure_realtime = AzureOpenAIRealtime() if AzureOpenAIRealtime else None
openai_realtime = OpenAIRealtime() if OpenAIRealtime else None
bedrock_realtime = BedrockRealtime() if BedrockRealtime else None
xai_realtime = XAIRealtime() if XAIRealtime else None
vertex_llm_base = VertexBase() if VertexBase else None
