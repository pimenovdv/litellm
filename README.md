...
2.  **Frontend (Next.js)**: A dashboard (`frontend`) for managing users, keys, and budgets, completely decoupled from the backend codebase and communicating strictly via REST API.
