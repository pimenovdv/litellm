...
- [x] Удалить файлы из .devcontainer: `.devcontainer/post-create.sh`, `.devcontainer/devcontainer.json`.
- [ ] Удалить файлы из packaging: `packaging/homebrew/lite.rb`, `packaging/homebrew/README.md`.
