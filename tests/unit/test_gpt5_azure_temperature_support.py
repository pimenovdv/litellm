...
try:
    from litellm.llms.openai_like.responses.transformation import OpenAIResponsesAPIConfig
    HAS_OPENAI_LIKE = True
except ImportError:
    HAS_OPENAI_LIKE = False

@pytest.mark.skipif(not HAS_OPENAI_LIKE, reason="openai_like not available")
